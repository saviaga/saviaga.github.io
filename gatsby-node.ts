...
export function createSchemaCustomization({ actions }: CreateSchemaCustomizationArgs): void {
  const { createTypes } = actions;

  // Explicitly define the MDX frontmatter schema to handle optional fields
  createTypes(`
    type MdxFrontmatter {
      title: String!
      summary: String
